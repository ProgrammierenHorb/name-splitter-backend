...
public class InMemoryTitleStorage implements TitleStorageService {
    ...
    public List<TitleData> academicTitles = new ArrayList<>(List.of(
            ...
            new TitleData("Dr\\.?\\s*h\\.?\\s*c\\.?\\s*mult\\.?\\s", "Dr.h.c.mult.", null, 80),
            new TitleData("Dr\\.?\\s*h\\.?\\s*c\\.?\\s", "Dr.h.c.", null, 90),
            new TitleData("Dr\\.?-Ing\\.?\\s", "Dr.-Ing.", null, 100),
            new TitleData("Dr\\.?\\s", "Dr.", null, 110),
            new TitleData("Doktor\\s?", "Dr.", Gender.MALE, 110),
            new TitleData("Doktorin\\s?", "Dr.", Gender.FEMALE, 110),
